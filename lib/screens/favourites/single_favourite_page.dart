...
class SingleFavouritePage extends StatefulWidget {
  ...
  const SingleFavouritePage(this.favourite, {Key? key}) : super(key: key);
                ...
                ? Column(
                    children: [
                      ...
                      RadioListTile<int>(
                        ...
                        title: const Text('Only on price increases'),
                      ),
                    ],
                  )
                : Container(),
            Center(
              child: Padding(
                ...
                child: ElevatedButton(
                  ...
                  style: ButtonStyle(
                    backgroundColor:
                        MaterialStateProperty.all<Color>(ThemeColor.deepRed),
    ...
    return await showDialog(
            ...
            builder: (context) => AlertDialog(
                  ...
                  actions: [
                    ...
                    TextButton(
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all(ThemeColor.deepRed),
